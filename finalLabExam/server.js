...
const apiAuthRoutes = require("./GameWebProject/routes/apiAuthRoutes");
...
//   try {
//     const totalGames = await Game.countDocuments({ name: new RegExp(query, "i") });
//     const totalPages = Math.ceil(totalGames / pageSize);
//     const games = await Game.find({ name: new RegExp(query, "i") }).skip(skip).limit(pageSize);
